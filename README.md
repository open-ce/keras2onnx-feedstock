...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/keras2onnx-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12188&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/keras2onnx-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `keras2onnx` can be installed with:

```
conda install keras2onnx
```

It is possible to list all of the versions of `keras2onnx` available on your platform with:
